...
<form method="post">
    ...
    <center> <input type ="submit" value ="Popularnosci" name = "popul"/>
        <input type ="submit" value ="% Zwyciestw" name = "zwyc"/></br>
        <input type ="submit" value ="Wydajnosci bialymi" name = "white"/>
        <input type ="submit" value ="Wydajnosci czarnymi" name = "black"/>
   </center>
</form>
<?php
    echo "<br>";
