    ...
    if($valid){
        ...
        if($db_respond = @$connection->query($check)){
            ...
            if(!$rownum){
                ...
                echo $fooarr['Wins_As_White'];
                echo $fooarr['Wins_As_Black'];
                echo $fooarr['Loses_As_White'];
                echo $fooarr['Loses_As_Black'];
            ...
            echo '</br></br><center><b>Statystyka zostala dodana!</b></center>';
        }
